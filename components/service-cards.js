    ...
    <div className="max-w-6xl mx-auto p-6 flex flex-wrap gap-x-6 justify-center">
      {items.map((item) => (
        ...
        >
          ...
          <div className="p-4">
            <Link href={`/services/${item.href}`} className="bg-blue-500 flex items-center mx-auto justify-center text-white text-sm font-medium py-2 px-6 rounded-full shadow hover:bg-blue-600 transition w-1/2">
              Learn More
            </Link>
          </div>
        </div>
